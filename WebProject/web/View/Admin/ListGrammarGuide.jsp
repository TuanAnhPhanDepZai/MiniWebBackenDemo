<%-- 
    Document   : ListGrammarGuide
    Created on : Dec 16, 2017, 5:13:48 PM
    Author     : Tuan Anh
--%>
...
<html>
    <head>
        ...
        <title>Them danh sach huong dan ngu phap </title>
    </head>
    <body class="no-skin">
                    ...
                    <div class="main-content-inner">
                        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                            <ul class="breadcrumb">
                                ...
                                <li>
                                    <a href="#">Quan li huong dan ngu phap</a>
                                </li>
                                <li class="active">Them danh sach bai huong dan</li>
                            </ul><!-- /.breadcrumb -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12">
                                            <table id="simple-table" class="table  table-bordered table-hover">
                                                ...
                                                <c:forEach items="${listGramarGuide}" var="list" >
                                                    <tr> 
                                                        <td  class="center">

                                                            ${list.idgrammarguideline}
                        ...
                        <form action="InsertGrammarGuideController">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Thêm thông tin </label>

                                    <input type="text" id="form-field-1-1" placeholder="Thêm thông tin tại đây" class="form-control"  name="name" />
